...
|------------- | ------------- | -------------|
|[**commentDelete**](#commentdelete) | **DELETE** /Comment | |
|[**commentGet**](#commentget) | **GET** /Comment | |
|[**commentPost**](#commentpost) | **POST** /Comment | |

# **commentDelete**
> CommentResponseApiResponse commentDelete()
...
let commentId: string; // (optional) (default to undefined)

const { status, data } = await apiInstance.commentDelete(
    commentId
);
```
...
|------------- | ------------- | ------------- | -------------|
| **commentId** | [**string**] |  | (optional) defaults to undefined|
